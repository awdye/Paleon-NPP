...
#what percentage of measurements are missing for each census time
percMissing<-data.frame(DBH1989=sum(how.census$DBH1989==-99.0)/7161*100,DBH1998=sum(how.census$DBH1998==-99.0)/7161*100,
                        DBH2002=sum(how.census$DBH2002==-99.0)/7161*100,DBH2010=sum(how.census$DBH2010==-99.0)/7161*100)
